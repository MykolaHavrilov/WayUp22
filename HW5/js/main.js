...
const questions = [
    {
        question: 'Сколько цветов имеет радуга?',
        options: [
            '13',
            '5',
            '7',
    ...
    {
        question: 'У Вас есть 20 яблок, 3 яблока съели сами, 5 отдали, сколько осталось яюлок?',
        options: [
            '12',
            '20',
            '17',
    ...
    {
        question: 'Full Stack Developer - что должен знать?',
        options: [
...
btnTryAgain.addEventListener('click', tryAgein);
